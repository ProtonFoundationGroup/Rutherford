...
import RutherfordMenu from '../modules/menu'
...
function onReady () {
  ...
  let rutherfordMenu = new RutherfordMenu(mwin)
  rutherfordMenu.create()
  /** for context menus */
