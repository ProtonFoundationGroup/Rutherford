...
const log = logger.create('ProtonNode')

const DEFAULT_NODE_TYPE = 'proton'
...
/**
 * Proton nodes manager.
 */
class ProtonNode extends EventEmitter {
  constructor () {
    super()
...
ProtonNode.STARTING = 0

export default new ProtonNode()
