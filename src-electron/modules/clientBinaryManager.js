    ...
    return got(BINARY_URL, {
      ...
      .then(localConfig => {
        ...
        return mgr
          .init({
            folders: [
              path.join(Settings.userDataPath, 'binaries', 'Proton', 'unpacked')
            ]
          })
          .then(() => {
          ...
          dialog.showMessageBox(
            {
              type: 'warning',
              buttons: ['OK'],
              message: global.i18n.t('rutherford.errors.nodeChecksumMismatch.title'),
              detail: global.i18n.t(
                'rutherford.errors.nodeChecksumMismatch.description',
                {
                  type: nodeInfo.type,
